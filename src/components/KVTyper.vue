    ...
    <div class="page-table">
      <div class="table-cell text-center">
        <div class="container">
          ...
          <h2 class="typer-title"><vue-typer :text="['I am a graduate student','and major in Information Management.']"></vue-typer></h2>
...
import ImgPicBg from '../assets/images/head-bg2.png'
...
.kv {
  ...
  &-typer {
    ...
    .home-s-btn {
      ...
      -webkit-border-radius: $font4*4;
      -moz-border-radius: $font4*4;
      border-radius: $font4*4;
      .dot {
        display: block;
        height: $font4*2 - 2px;
        width: $font4*2 - 2px;
